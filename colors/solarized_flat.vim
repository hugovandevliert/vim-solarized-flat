" Name:         Solarized Flat
" Author:       Ethan Schoonover (edited by Hugo van de Vliert)
" Maintainer:   Ethan Schoonover (edited by Hugo van de Vliert)
" License:      Vim License (see `:help license`)
" Last Updated: Sun Jan 15 21:14:54 2023
...
let s:t_Co = get(g:, 'solarized_flat_use16', 0) ? 16 : s:t_Co
let s:italics = s:italics && get(g:, 'solarized_flat_italics', 1)
let s:termtrans = get(g:, 'solarized_flat_termtrans', 0) && !has('gui_running')
...
if &background ==# 'dark'
  ...
  if get(g:, 'solarized_flat_visibility', '') ==# 'high'
  ...
  elseif get(g:, 'solarized_flat_visibility', '') ==# 'low'
  ...
  elseif get(g:, 'solarized_flat_diffmode', '') ==# 'low'
  ...
  if get(g:, 'solarized_flat_statusline', '') ==# 'low'
  ...
  if get(g:, 'solarized_flat_extra_hi_groups', 1)
    ...
    if get(g:, 'solarized_flat_statusline', '') ==# 'flat'
