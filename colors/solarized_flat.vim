" Name:         Solarized Flat
" Author:       Ethan Schoonover (altered by Hugo van de Vliert)
" Maintainer:   Ethan Schoonover (altered by Hugo van de Vliert)
" License:      Vim License (see `:help license`)
" Last Updated: Mon Jan 23 16:42:49 2023

" Generated by Colortemplate v2.2.0

hi clear
let g:colors_name = 'solarized_flat'
...
if &background ==# 'dark'
  ...
  hi SpecialKey guifg=#657b83 guibg=NONE gui=bold cterm=bold
  ...
  hi MatchParen guifg=#fdf6e3 guibg=NONE gui=bold cterm=bold
  ...
  hi ALEInfoSign guifg=#2aa198 guibg=NONE gui=NONE cterm=NONE
  hi ALEWarningSign guifg=#b58900 guibg=NONE gui=NONE cterm=NONE
  ...
  hi ALEError guifg=#dc322f guibg=NONE guisp=#dc322f gui=underline cterm=underline
  hi ALEErrorLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi ALEInfo guifg=#2aa198 guibg=NONE guisp=#2aa198 gui=underline cterm=underline
  hi ALEInfoLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi ALEWarning guifg=#b58900 guibg=NONE guisp=#b58900 gui=underline cterm=underline
  ...
  hi SignifySignAdd guifg=#859900 guibg=NONE gui=NONE cterm=NONE
  hi SignifySignChange guifg=#b58900 guibg=NONE gui=NONE cterm=NONE
  hi SignifySignDelete guifg=#dc322f guibg=NONE gui=NONE cterm=NONE
  if !s:italics
  ...
  hi MatchParen guifg=#002b36 guibg=NONE gui=bold cterm=bold
  hi NonText guifg=#839496 guibg=NONE gui=bold cterm=bold
  hi SpecialKey guifg=#839496 guibg=NONE gui=bold cterm=bold
  hi SpellBad guifg=#6c71c4 guibg=NONE guisp=#6c71c4 gui=undercurl cterm=underline
  hi SpellCap guifg=#6c71c4 guibg=NONE guisp=#6c71c4 gui=undercurl cterm=underline
  hi SpellLocal guifg=#b58900 guibg=NONE guisp=#b58900 gui=undercurl cterm=underline
  hi SpellRare guifg=#2aa198 guibg=NONE guisp=#2aa198 gui=undercurl cterm=underline
  ...
  hi VertSplit guifg=#eee8d5 guibg=#eee8d5 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi MatchParen ctermfg=230 ctermbg=NONE cterm=bold
    ...
    hi ALEInfoSign ctermfg=37 ctermbg=NONE cterm=NONE
    ...
    hi! link ALEStyleWarningSign ALEWarningSign
    hi! link ALEStyleWarningSignLineNr ALEWarningSignLineNr
    hi SignifySignAdd ctermfg=106 ctermbg=NONE cterm=NONE
    hi SignifySignChange ctermfg=136 ctermbg=NONE cterm=NONE
    hi SignifySignDelete ctermfg=160 ctermbg=NONE cterm=NONE
    if !s:italics
    ...
    hi MatchParen ctermfg=235 ctermbg=NONE cterm=bold
    hi NonText ctermfg=246 ctermbg=NONE cterm=bold
    hi SpecialKey ctermfg=246 ctermbg=NONE cterm=bold
    hi SpellBad ctermfg=61 ctermbg=NONE cterm=underline
    hi SpellCap ctermfg=61 ctermbg=NONE cterm=underline
    hi SpellLocal ctermfg=136 ctermbg=NONE cterm=underline
    hi SpellRare ctermfg=37 ctermbg=NONE cterm=underline
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi SpecialKey ctermfg=11 ctermbg=NONE cterm=bold
    ...
    hi ALEInfoSign ctermfg=6 ctermbg=NONE cterm=NONE
    ...
    hi MatchParen ctermfg=8 ctermbg=NONE cterm=bold
    hi NonText ctermfg=12 ctermbg=NONE cterm=bold
    hi SpecialKey ctermfg=12 ctermbg=NONE cterm=bold
    hi SpellBad ctermfg=13 ctermbg=NONE cterm=underline
    hi SpellCap ctermfg=13 ctermbg=NONE cterm=underline
    hi SpellLocal ctermfg=3 ctermbg=NONE cterm=underline
    hi SpellRare ctermfg=6 ctermbg=NONE cterm=underline
